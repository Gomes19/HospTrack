    ...
    <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                            <span><b>@if(Auth::user()->it_tipo_utilizador == 1) Usuários @else Funcionários @endif</b></span>
                            <div class="mt-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="mt-2">
                                <h2 class="counter">{{ $totalMedicos }}</h2>
                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                            <span><b> @if(Auth::user()->it_tipo_utilizador == 1) Hospitais @else Serviços @endif</b></span>
                            <div class="mt-2">
                                <h2 class="counter">@if(Auth::user()->it_tipo_utilizador == 1)  {{ $totalHospitais }} @else {{ $totalServicos }} @endif</h2>
                            </div>
                            </div>
                            <div>
