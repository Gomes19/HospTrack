                ...
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                   ...
                   <li class="nav-item dropdown">
                      <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img src="{{ asset('assets/images/avatars/01.png') }}" alt="User-Profile" class="theme-color-grey-img img-fluid rounded-pill avatar-50"  loading="lazy">
                        @else
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                            ...
                            <p class="mb-0 caption-sub-title">@if(Auth::user()->it_tipo_utilizador == 1) Administrador @elseif(Auth::user()->hospital()->first()->pivot->cargo == 0) Admin Hospital  @elseif(Auth::user()->hospital()->first()->pivot->cargo == 1)  Marc. ponto @else Indefinido @endif </p>
                     </div>
                      </a>
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                     @if( Auth::user()->it_tipo_utilizador == 1)
                        <li><a class="dropdown-item" href="{{ route('admin.user.perfil') }}">Perfil</a></li>
                     @else
                        <li><a class="dropdown-item" href="{{ route('gestao.user.perfil') }}">Perfil</a></li>
                     @endif    
